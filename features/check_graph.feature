...
Feature: User can check data on graphs page
  ...
  Scenario: Check user can see graphs name and metric data that cannot be N/A
    ...
    When I should see name graph 'Load Average - /Server/SSH/Linux - qa-ubuntu-11.zenoss.lab'
    When I should see name graph 'Memory Utilization - /Server/SSH/Linux - qa-ubuntu-11.zenoss.lab'
    When I should see name graph 'Memory Usage - /Server/SSH/Linux - qa-ubuntu-11.zenoss.lab'
    When I should see name graph 'IO Throughput - /Server/SSH/Linux - qa-ubuntu-11.zenoss.lab'
